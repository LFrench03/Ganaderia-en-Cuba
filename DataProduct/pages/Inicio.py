...
with st.expander("¿Quiénes somos?"):
    st.write("Un equipo de estudiantes de la carrera de Ciencia de Datos que ha emprendido una investigación sobre uno de los temas más controvertidos en Cuba: la ganadería. Como parte de este proyecto, hemos creado un identificador único llamado DataPecuario. Este identificador funciona como una marca para representar el conjunto resultante de la fusión de todas las partes independientes en las que se divide esta investigación sobre el sector pecuario cubano.")
