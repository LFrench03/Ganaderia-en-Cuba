...
st.markdown('<p style=font-size:24px;font-weight:bold;color:#0a2940;"><i>- Ganado:</i></p>', unsafe_allow_html=True)
...
st.markdown('<p style=font-size:24px;font-weight:bold;color:#0a2940;"><i>- Acerca de:</i></p>', unsafe_allow_html=True)
